...
N 570 70 660 70 { lab=#net1}
N 430 70 460 70 { lab=SENS_IN}
N 620 190 660 190 { lab=REF_IN}
N 1130 90 1140 90 { lab=#net2}
N 1050 30 1175 30 { lab=VDD}
N 1175 30 1175 60 { lab=VDD}
N 1085 30 1085 60 { lab=VDD}
N 1050 150 1175 150 { lab=VSS}
N 1175 120 1175 150 { lab=VSS}
N 1085 120 1085 150 { lab=VSS}
N 1250 170 1250 210 { lab=VSS}
N 1250 90 1250 110 { lab=DOUT_CLOAD}
N 1220 90 1250 90 { lab=DOUT_CLOAD}
N 460 70 510 70 { lab=SENS_IN}
N 510 400 510 440 { lab=VSS}
N 510 320 510 340 { lab=#net3}
N 510 320 560 320 { lab=#net3}
...
C {SDC_v2p1.sym} 600 50 0 0 {name=X1}
C {INV_v1p1.sym} 1010 90 0 0 {name=XBUFFINV1}
C {INV3X_v1p1.sym} 1100 90 0 0 {name=XBUFFINV2}
C {devices/lab_pin.sym} 1050 30 0 0 {name=l1 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1050 150 0 0 {name=l3 sig_type=std_logic lab=VSS}
C {devices/capa.sym} 1250 140 0 0 {name=C_LOAD
m=1
value=10p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 1250 210 0 0 {name=l7 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1250 90 1 0 {name=l4 sig_type=std_logic lab=DOUT_CLOAD}
